...
import { useEventAgent, type ChatMessage } from '@/components/providers/EventAgentProvider';
...
const QUICK_ACTIONS = [
  { label: 'Hackathon', prompt: 'Create a hackathon event with team registration' },
        ...
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center px-4">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Describe your event and I&apos;ll help you create the form fields and details.
            </p>
