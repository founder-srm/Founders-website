...
export const createClient = () => {
  ...
  const serviceRoleKey =
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVlZHBsdm9wa2h3dWhocXVhZ2Z3Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNzI0MzU4NSwiZXhwIjoyMDIyODE5NTg1fQ.LsBV4sC3_adeSSUr3-PWhQXIUnpitMNPO-Hf5SxA96U';
