              ...
              registrations?.map((reg) => (
                ...
                >
                  <div className=' w-full flex flex-row justify-between items-center space-x-4'>
                    ...
                    <HoverCard>
                      <HoverCardTrigger>
                        <Ticket className='cursor-pointer' onClick={() => Router.push(`/dashboard/upcoming/register/success?ticketid=${reg.ticket_id}`)} />
                      </HoverCardTrigger>
                      <HoverCardContent>
                  ...
                  <div className="text-sm text-gray-500 space-y-1">
                    ...
                    <p>Registered: {reg.created_at ? new Date(reg.created_at).toLocaleString('en-IN', {
                        day: '2-digit',
                        month: 'long',
                        year: 'numeric',
                        hour: '2-digit',
