  ...
  return (
    <Suspense unstable_expectedLoadTime={10} fallback={<div>Loading...</div>}>
      <main className="overflow-hidden w-full h-full relative">
        <div className="h-[95vh] overflow-y-auto px-8 pb-16 pt-16" suppressHydrationWarning ref={containerRef}>
        ...
        <DotPattern width={20} height={20} cx={1} cy={1} cr={1} className={cn("[mask-image:linear-gradient(to_bottom_left,white,transparent,transparent)] ")} />
      </main>
    </Suspense>
  );
}
